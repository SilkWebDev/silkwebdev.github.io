class Footer extends HTMLElement{email="jskbwk@gmail.com";tel="07725247726";facebookLink="#";instagramLink="#";constructor(){super()}connectedCallback(){this.innerHTML=`    
    <footer>
    ...
    </footer>`}}customElements.define("footer-element",Footer);